...
DataAssociation::DataAssociation()
    : max_limit_dist_(/* meter */ 10.0), score_threshold_(0.1)
{
    ...
    can_assgin_matrix_(autoware_msgs::Semantic::CAR, autoware_msgs::Semantic::BUS) = 1;
    ...
    can_assgin_matrix_(autoware_msgs::Semantic::BUS, autoware_msgs::Semantic::CAR) = 1;
    ...
    max_dist_matrix_(autoware_msgs::Semantic::CAR, autoware_msgs::Semantic::UNKNOWN) = 1.5;
    max_dist_matrix_(autoware_msgs::Semantic::CAR, autoware_msgs::Semantic::TRUCK) = 4.0;
    max_dist_matrix_(autoware_msgs::Semantic::CAR, autoware_msgs::Semantic::BUS) = 4.0;
    max_dist_matrix_(autoware_msgs::Semantic::TRUCK, autoware_msgs::Semantic::UNKNOWN) = 1.5;
    ...
    max_dist_matrix_(autoware_msgs::Semantic::BUS, autoware_msgs::Semantic::UNKNOWN) = 1.5;
    ...
    max_dist_matrix_(autoware_msgs::Semantic::BICYCLE, autoware_msgs::Semantic::UNKNOWN) = 1.0;
    max_dist_matrix_(autoware_msgs::Semantic::BICYCLE, autoware_msgs::Semantic::MOTORBIKE) = 2.0;
    max_dist_matrix_(autoware_msgs::Semantic::MOTORBIKE, autoware_msgs::Semantic::UNKNOWN) = 2.0;
    max_dist_matrix_(autoware_msgs::Semantic::MOTORBIKE, autoware_msgs::Semantic::BICYCLE) = 2.0;
    max_dist_matrix_(autoware_msgs::Semantic::PEDESTRIAN, autoware_msgs::Semantic::UNKNOWN) = 1.0;
    ...
    for (auto tracker_itr = trackers.begin(); tracker_itr != trackers.end(); ++tracker_itr, ++tracker_idx)
    {
        for (size_t measurement_idx = 0; measurement_idx < measurements.feature_objects.size(); ++measurement_idx)
        {
            ...
            if (can_assgin_matrix_((*tracker_itr)->getType(), measurements.feature_objects.at(measurement_idx).object.semantic.type))
            {
                ...
                score = (max_limit_dist_ - std::min(dist, max_limit_dist_)) / max_limit_dist_;
                if (max_dist < dist)
                    score = 0.0;
            }
