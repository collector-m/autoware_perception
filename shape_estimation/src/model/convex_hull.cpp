                                ...
                                bool &orientation_output)
{
  ...
  for (size_t i = 0; i < v_polygon_points.size(); ++i)
  {
    ...
    point.x = (double)v_polygon_points.at(i).x / 1000.0;
    point.y = (double)v_polygon_points.at(i).y / 1000.0;
    point.z = 0.0;
  ...
  pose_output.position.x = centroid.x;
  pose_output.position.y = centroid.y;
